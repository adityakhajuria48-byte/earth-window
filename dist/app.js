...
function openScene(f){
  ...
  content.append(text('p','Previews show the complete source tile. Outlines show where these data were collected. Valid pixels or clear ground are not guaranteed throughout a footprint. Use Before A or After B, then Display on globe, to place supported bands on the 3D surface.','detail-note'));
